...
#--  page 1------
    def main(sf):
        ...
        sf.lab=Button(sf.mainf2,text= "Click Here to enter the Universe of delightful Pizzas",command=lambda:sf.Login(),cursor="hand2", bd=10 ,font=("cooper black",30, 'bold'),fg="white",bg="#0b1335")
...
#------ page 2------
    def Login(sf):
        ...
        sf.rg=Button(sf.loginf2,text="New to Lovely Pizzas",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
